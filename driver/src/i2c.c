/********************************************************************************************************//**
 * @file    i2c.c	
 * @brief   The c file of the I2c Unit firmware functions.
 * @author  
 * @version V1.00
 * @date:   2016-12-30
 * @note
...
/*********************************************************************************************************//**
  ...
  * @param  I2Cx: where I2Cx is the selected I2C peripheral, x can be 0.
  * @retval None
  ***********************************************************************************************************/
void I2C_DeInit(AM_I2C_TypeDef* I2Cx)
{
  if (I2Cx == AM_I2C0)
  {
    RSTCU_APBPerip0Reset(RSTCU_APBRST1_I2C0, ENABLE);
  }
}
...
/*********************************************************************************************************//**
  ...
  * @retval None
  ***********************************************************************************************************/
void I2C_Init(AM_I2C_TypeDef* I2Cx, I2C_InitTypeDef* I2C_InitStruct)
{
  u32 PCLK_Freq;
  ...
  PCLK_Freq = SystemCoreClock;

  switch(I2Cx->CR & 0xC000)
  {
    case 0:
    I2Cx->SHPGR = (PCLK_Freq*9)/(I2C_InitStruct->I2C_Speed*20) - 6;
    I2Cx->SLPGR = (PCLK_Freq*11)/(I2C_InitStruct->I2C_Speed*20) - 6;
    break;

    case 0x4000:
    I2Cx->SHPGR = (PCLK_Freq*9)/(I2C_InitStruct->I2C_Speed*20) - 8;
    I2Cx->SLPGR = (PCLK_Freq*11)/(I2C_InitStruct->I2C_Speed*20) - 8;
    break;

    case 0x8000:
    I2Cx->SHPGR = (PCLK_Freq*9)/(I2C_InitStruct->I2C_Speed*20) - 9;
    I2Cx->SLPGR = (PCLK_Freq*11)/(I2C_InitStruct->I2C_Speed*20) - 9;
    break;
...
/*********************************************************************************************************//**
  ...
  * @param  I2Cx: acknowledgeI2Cx is the selected I2C peripheral, x can be 0.
...
/*********************************************************************************************************//**
  ...
  * @param  I2Cx: I2Cx is the selected I2C peripheral, x can be 0.
