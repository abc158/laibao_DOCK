/********************************************************************************************************//**
 * @file    usart.c	
 * @brief   The c file of the Usart Unit firmware functions.
 * @author  
 * @version V1.00
 * @date:   2016-12-30
 * @note
...
#define MDR_LSB_MSB_Mask          ((u32)0xFFFFFFFB)
 ...
 * @param USARTx: This parameter can be AM_UARTx, x = 0~5.
 * @retval None
 ************************************************************************************************************/
void USART_DeInit(AM_USART_TypeDef* USARTx)
{
  if (USARTx == AM_UART0)
    RSTCU_APBPerip0Reset(RSTCU_APBRST0_UART0, ENABLE);
  else if (USARTx == AM_UART2)
    RSTCU_APBPerip0Reset(RSTCU_APBRST0_UART2, ENABLE);
  else if (USARTx == AM_UART4)
    RSTCU_APBPerip0Reset(RSTCU_APBRST0_UART4, ENABLE);
  else if (USARTx == AM_UART5)
    RSTCU_APBPerip0Reset(RSTCU_APBRST0_UART5, ENABLE);
	else if (USARTx == AM_UART1)
    RSTCU_APBPerip1Reset(RSTCU_APBRST1_UART1, ENABLE);
	else if (USARTx == AM_UART3)
    RSTCU_APBPerip1Reset(RSTCU_APBRST1_UART3, ENABLE);
}
 ...
 * @retval None
 ************************************************************************************************************/
void USART_Init(AM_USART_TypeDef* USARTx, USART_InitTypeDef* USART_InitStruct)
{
 ...
 *   This parameter can be one of the following values:
 *         @arg USART_IER_MSIE
 *         @arg USART_IER_RLSIE  Receive Line Status Interrupt Enable (Irpt_RLSI)
...
/*********************************************************************************************************//**
 * @brief Enable or Disable the UART0 LIN operation mode.
 * @param NewState: This parameter can be ENABLE or DISABLE.
 * @retval None
 ************************************************************************************************************/
void USART_LINCmd(ControlStatus NewState)
{
  AM_UART0->LCR = (AM_UART0->LCR & (~(1<<8))) | NewState;
}

/*********************************************************************************************************//**
 * @brief Enable or Disable the UART0 LIN operation mode.
 * @param Mode: This parameter can be USART_LIN_MASTER or USART_LIN_SLAVE.
 * @retval None
 ************************************************************************************************************/
void USART_LINModeSet(u16 Mode)
{
  AM_UART0->LCR = (AM_UART0->LCR & (~(1<<9))) | Mode;
}

/*********************************************************************************************************//**
 * @brief Sets the UART0 LIN Break detection length.
 * @param  Len: specifies the LIN break detection length.
 *   This parameter can be one of the following values:
 *     @arg USART_LIN_BREAK_10BITS: 10-bit break detection
 *     @arg USART_LIN_BREAK_11BITS: 11-bit break detection
 * @retval None
 ************************************************************************************************************/
void USART_LINBreakDetectLenSet(uint16_t Len)
{
  AM_UART0->LCR = (AM_UART0->LCR & (~(1<<12))) | Len;
}

/*********************************************************************************************************//**
 * @brief UART0 LIN Transmits break characters.
 * @param None
 * @retval None
 ************************************************************************************************************/
void USART_LINSendBreak(void)
{
  AM_UART0->LCR |= USART_LIN_SBK_SET;
}

/*********************************************************************************************************//**
 * @brief Enable or Disable the UART0 LIN interrupts.
 * @param USART_INT: Specify if the USART interrupt source to be enabled or disabled.
 *   This parameter can be one of the following values:
 *         @arg USART_INT_LINBREAK
 *         @arg USART_INT_LINHEAD
 * @param NewState: This parameter can be ENABLE or DISABLE.
 * @retval None
 ************************************************************************************************************/
...
/*********************************************************************************************************//**
 * @brief Clear the UART0 LIN interrupt pending bits.
 * @param USART_INT: Specify if the USART interrupt pending bit to be clear.
 *   This parameter can be one of the following values:
 *         @arg USART_INT_LINBREAK
 *         @arg USART_INT_LINHEAD
 * @retval None
...
{
  AM_UART0->IIR = USART_INT;
}

/*********************************************************************************************************//**
 * @brief Get the UART0 LIN interrupt pending bits.
 * @param USART_STA: Specify if the USART interrupt source to be enabled or disabled.
 *   This parameter can be one of the following values:
 *         @arg USART_STA_LINBREAK
 *         @arg USART_STA_LINHEAD
 *         @arg USART_STA_LINALL
 * @param NewState: This parameter can be ENABLE or DISABLE.
 * @retval None
 ************************************************************************************************************/
u16 USART_LINIntStatusGet(u32 USART_STA)
{
	return (AM_UART0->IIR & USART_STA);
}
