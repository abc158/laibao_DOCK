/********************************************************************************************************//**
 * @file    rtc.h	
 * @brief   The header file of the Rtc Unit library.
 * @author  
 * @version V1.00
 * @date:   2016-12-30
 * @note
...
typedef enum
{
  RTC_LSESM_NORMAL = 0,       /*!< Shortly startup time but higher power consumption. */
  RTC_LSESM_FAST              /*!< Little power consumption but longer startup time. */
} RTC_LSESM_Enum;
/**
...
#define RTC_WAKEUP_CALALM 0x00000800
#define RTC_WAKEUP_CALSEC 0x00001000
/**
  * @}
  */
...
#define RTC_INT_CALALM    0x00000008
#define RTC_INT_CALSEC    0x00000010
/**
  * @}
  */
